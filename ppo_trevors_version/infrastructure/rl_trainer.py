...
#https://chatgpt.com/share/67bd4917-bcac-8004-83e6-3f8636b0e141
#look at above link for ways to parallelize
...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(self, itr, load_initial_expertdata, collect_policy, batch_size):
        ...
        #         print("Error: Expert Data File is None")
        #     print(f"First iteration: Loading Expert Data from {load_initial_expertdata}")

        #     with open(load_initial_expertdata, 'rb') as exp_data_file:
        #         loaded_paths=pickle.load(exp_data_file)

        #     print("First iteration: Expert Data Loaded Successfully")
        #     exp_returns = []
        #     for exp_path in loaded_paths:
        #         exp_returns.append(np.sum(exp_path["reward"]))
        #     print("Expert Data Statistics:")
        #     print("--Num trajectories:", len(loaded_paths))
        #     print("--Mean Return:", np.mean(exp_returns))
        #     print("--Std Return:", np.std(exp_returns))
        ...
        training_trajs,envsteps_this_batch= utils.sample_trajectories(env=self.env,
        ...
        return training_trajs, envsteps_this_batch, train_video_paths
